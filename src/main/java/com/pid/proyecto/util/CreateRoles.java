...
public class CreateRoles implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (rolSistemaService.Listar().isEmpty()
            ...
            TodosLosRoles.add(new Rol(RolNombre.ROLE_SECRETARIO_DOCENTE_SISTEMA.name()));
            ...
            Rol rolAdmin = rolSistemaService.getByRol(RolNombre.ROLE_ADMIN_SISTEMA.name()).get();
            ...
            permisosUser.add(permisosService.getByPermiso(PermisoNombre.ROLE_C_USUARIO.name()).get());
            permisosUser.add(permisosService.getByPermiso(PermisoNombre.ROLE_R_USUARIO.name()).get());
            permisosUser.add(permisosService.getByPermiso(PermisoNombre.ROLE_D_USUARIO.name()).get());
            Rol rolUser = rolSistemaService.getByRol(RolNombre.ROLE_USUARIO_SISTEMA.name()).get();
...
//        List<Permisos> permisosDenunciante = new LinkedList();
    ...
    public List<Permiso> PermisosPdfResolucionComisiones(List<Character> Lc) {
        ...
        for (char c : Lc) {
            if (c == 'c') {
                lista.add(new Permiso(PermisoNombre.C_PDF_RESOLUCION_COMISIONES.name()));
            }
            if (c == 'r') {
                lista.add(new Permiso(PermisoNombre.R_PDF_RESOLUCION_COMISIONES.name()));
            }
            if (c == 'u') {
                lista.add(new Permiso(PermisoNombre.U_PDF_RESOLUCION_COMISIONES.name()));
            }
            if (c == 'd') {
                lista.add(new Permiso(PermisoNombre.D_PDF_RESOLUCION_COMISIONES.name()));
            }
        }
