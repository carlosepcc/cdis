...
@NamedQueries(
  {
    @NamedQuery(
      name = "PdfExpediente.findAll",
      query = "SELECT p FROM PdfExpediente p"
    ),
  }
)
public class PdfExpediente implements Serializable {
  ...
  public PdfExpediente(String descripcion) {
    this.descripcion = descripcion;
  }
  ...
  public boolean equals(Object object) {
    ...
    if (
      (this.idexpediente == null && other.idexpediente != null) ||
      (
        this.idexpediente != null &&
        !this.idexpediente.equals(other.idexpediente)
      )
    ) {
      return false;
    }
  ...
  public String toString() {
    return (
      "com.pid.proyecto.entity.PdfExpediente[ idexpediente=" +
      idexpediente +
      " ]"
    );
  }
